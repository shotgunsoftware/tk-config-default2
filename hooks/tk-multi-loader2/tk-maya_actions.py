...
class MayaActions(HookBaseClass):
    ...
    log.debug('>>>>> Launching tk-maya_actions.py')
    ...
    def _create_reference(self, path, sg_publish_data):
        ...
        This codes runs when ever a new reference is created
        ...
        # Assign shader every time new geo is referenced
        # also run when shader and geo exist
