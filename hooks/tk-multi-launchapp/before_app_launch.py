...
class BeforeAppLaunch(sgtk.Hook):
    ...
    def execute(self, app_path, app_args, version, engine_name, **kwargs):
        ...
        if engine_name == "tk-houdini":
            ...
            render_engine = sg.find_one(
                "Project", [["name", "is", project_name]], ["sg_render_engine"]
            ).get("sg_render_engine")
            ...
            otls_path = houdini_otls_template.apply_fields(current_context).replace(
                os.sep, "/"
            )
