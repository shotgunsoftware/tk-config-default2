...
from ss_config.hooks.tk_multi_publish2._3dequalizer.publish_camera import Ss3dequalizerCameraPublishPlugin


class _3dequalizerCameraPublishPlugin(Ss3dequalizerCameraPublishPlugin):
    """
