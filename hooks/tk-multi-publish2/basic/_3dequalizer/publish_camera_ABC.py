...
from ss_config.hooks.tk_multi_publish2._3dequalizer.publish_camera_ABC import Ss3deCameraABCPublishPlugin


class _3dequalizerCameraABCPublishPlugin(Ss3deCameraABCPublishPlugin):
    """
