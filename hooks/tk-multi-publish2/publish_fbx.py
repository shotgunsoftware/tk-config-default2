...
class MayaFBXPublishPlugin(HookBaseClass):
    """
    Plugin for publishing the Maya session as an FBX file.

    This hook relies on functionality found in the base file publisher hook in
    the publish2 app and should inherit from it in the configuration. The hook
    setting for this plugin should look something like this::

        hook: "{self}/publish_file.py:{config}/tk-multi-publish2/publish_fbx.py"
    ...
    def publish(self, settings, item):
        ...
        # Export scene to FBX
        # RA Need to get specific info from Daniel Wright for this to make sure
