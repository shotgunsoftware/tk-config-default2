...
class MotionBuilderSessionCollector(HookBaseClass):
    ...
    def process_current_session(self, parent_item):
        ...
        if project_root:
            ...
            self.logger.info(
                "Current Motion Builder project is: %s." % (project_root,),
                extra={
                    "action_button": {
                        "label": "Change Project",
                        "tooltip": "Change to a different Motion Builder project",
            ...
            self.logger.warning(
                "Could not determine the current Motion Builder project.",
                extra={
                    "action_button": {
                        "label": "Set Project",
    ...
    def collect_alembic_caches(self, parent_item, project_root):
        ...
        :param parent_item: Parent Item instance
        :param str project_root: The motion builder project root to search for alembics
        """
        ...
        for filename in os.listdir(cache_dir):
            ...
            super(MotionBuilderSessionCollector, self)._collect_file(
                parent_item,
                cache_path
            )
    ...
    def collect_playblasts(self, parent_item, project_root):
        ...
        :param parent_item: Parent Item instance
        :param str project_root: The motion builder project root to search for playblasts
        """
        ...
        for filename in os.listdir(movies_dir):
            ...
            item = super(MotionBuilderSessionCollector, self)._collect_file(
                parent_item,
                movie_path
            )
